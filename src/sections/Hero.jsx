...
//make them as self closing tag inside jsx
...
//github copilot assiting better while coding
const Hero = () => {
  ...
  return (
   ...
   min-h-screen
    gap-10 maxcontainer border-2 border-red-500 p-2'>
        ...
        sm:left-[10%] max-sm:px-6'>
          {shoes.map((shoe)=>(
            <div key={shoe}>
              ...
              //the above gets the current value of the state
